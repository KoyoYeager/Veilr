...
指定色のピクセルを検出し、周囲の背景色で置換する。3つのアルゴリズムから選択可能：

| アルゴリズム | 特徴 |
|---|---|
| **Chroma Key** (デフォルト) | CIE Lab色空間＋ソフトアルファブレンド＋デスピル |
| **Lab Mask** | CIE Lab色空間＋二値マスク＋膨張＋中央値置換 |
| **YCbCr** | 放送業界標準のYCbCr色空間＋ソフトアルファブレンド |
